...
namespace RecipeGUI
{
	class Lang
	{
		...
		public static string fileWarningContent = "The selected directory contains over 5,000 files. Are you sure you selected the correct directory?";

		public static string modDoesNotExist = "Error: Could not locate mod directory.";
		public static string outputDoesNotExist = "Error: Could not locate output directory.";
